...
class FullFetchJobRequestResponse(BaseModel):
    date_from: str
    date_to: str
    symbols: list[str]
...
class FullFetchJobResultResponse(BaseModel):
    provider: str
    symbols: list[str]
    date_from: str
    date_to: str
...
class FullFetchJobStatusResponse(BaseModel):
    job_id: str
    status: str
    message: str
    created_at: str
    ...
    result: FullFetchJobResultResponse | None
